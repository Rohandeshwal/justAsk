...
export class CardsComponent implements OnInit {
  ...
  // },
  {
    ...
    name:"Painting",
    description:"Professional painting service includes interior and exterior house painting, commercial painting, pressure washing, drywall repair & more. We will make your house the way you want to be. ",
 ...
 
  {
    ...
    description:"On call service for repair, installation and uninstallation of appliance like AC, Refrigerator, Washing Machine etc. We use latest technology jet pump for cleaning and service.",
